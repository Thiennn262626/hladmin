...
//   const handleChangeAttributeValueMedia = (attributeIndex: number, valueIndex: number, media_url: string, urlMedia: string) => {
//     setAttributes((prevAttributes) => {
//       const newAttributes = [...prevAttributes];
...
//     console.log(attributeIndex, valueIndex, locAttributeValueName);
//     resetSKUs();
//     setAttributes((prevAttributes) => {
//       const newAttributes = [...prevAttributes];
...
//     if (response) {
//       handleChangeAttributeValueMedia(attributeIndex, valueIndex, response?.media_url, response?.url);
//     }
//   };
...
//                             }
//                             handleAddItemToAttributeValue(index)
//                             handleChangeAttributeValue(index, attribute.attributesValue.length, name2);
//                             setName2('');
//                           }
//                         }}>
//                           Add

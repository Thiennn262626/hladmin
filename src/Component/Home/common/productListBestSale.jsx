...
const ProductListBestSale = () => {
  
    const [productListSale, setProductListSale] = useState([]);

    useEffect(() => {
        homeServices.getProductListBestSale().then((res) => {
          console.log(res);
  ...
  return (
    <div className="bg-white h-auto p-4 mb-4">
      <div className="flex flex-col items-start ">
        <h1 className="text-black text-xl font-bold pb-4">Danh sách có thể bán chạy sắp tới</h1>
      </div>
...
export default ProductListBestSale;

...
import { setOpenDrawerApply } from "../../Order/counterOrder";
import { orderServices } from "../../../services/orderService";

const DescriptionItem = ({ title, content }) => (
  <div className="site-description-item-profile-wrapper">
    <p className="site-description-item-profile-p-label !text-cyan-600">
      {title}:
    </p>
    {content}
  </div>
    ...
    >
      ...
      <Row>
        <Col span={24}>
          <DescriptionItem
            title="AddressID"
            content={data?.receiverAddressID}
          />
        </Col>
        <Divider />
        <Col span={24}>
          <DescriptionItem
            title="ContactName"
            content={data?.receiverContactName}
          />
        </Col>
      </Row>
      <Row>
